...
- **Skills** (`skills/`): `propositions` (onboard + extraction + mechanical gate + drift refresh，Operations A/B/C/D), `clarity-audit`, `proofread`（雙軌：Mode A 推導鏈 L1-L5／Mode B 實證 E1-E8）, `manuscript-audit` — domain-general manuscript QA
